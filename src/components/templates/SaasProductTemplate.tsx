...
const SaasProductTemplate: React.FC<SaasProductTemplateProps> = ({ colorPalette }) => {
  return (
    <div className="w-full">
      {/* Header */}
      <header className="px-6 py-5 border-b" style={{ backgroundColor: colorPalette.background, borderColor: colorPalette.textLight + '20' }}>
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="p-2 rounded-lg" style={{ backgroundColor: colorPalette.primary }}>
              <Monitor className="w-6 h-6" style={{ color: colorPalette.background }} />
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-8 leading-tight">
              <span style={{ color: colorPalette.text }}>Streamline your</span>
              <br />
              <span style={{ color: colorPalette.primary }}>product workflow</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <div key={index} className="text-center p-8 rounded-2xl hover:shadow-lg transition-all duration-300" style={{ backgroundColor: colorPalette.background, border: `1px solid ${colorPalette.textLight}20` }}>
                ...
                <h3 className="text-xl font-bold mb-4" style={{ color: colorPalette.text }}>
                  {feature.title}
                </h3>
            ...
            <div className="flex items-center justify-center space-x-8 mb-8">
              {['Trusted by', '10,000+', 'companies'].map((text, index) => (
                <div key={index} className="flex items-center space-x-2">
                  ...
                  <span className={index === 1 ? "text-2xl font-bold" : "text-lg"} style={{ color: index === 1 ? colorPalette.primary : colorPalette.textLight }}>
                    {text}
                  </span>
                </div>
              ))}
