  ...
  return (
    <div className="w-full relative overflow-hidden">
      ...
      <div 
        ...
        style={{ 
          background: `radial-gradient(circle at 20% 50%, ${colorPalette.primary}, transparent 50%), radial-gradient(circle at 80% 20%, ${colorPalette.secondary}, transparent 50%), radial-gradient(circle at 40% 80%, ${colorPalette.accent}, transparent 50%)`
        }}
      />
      ...
      <header className="relative z-10 px-6 py-6 backdrop-blur-md bg-white/10 border-b border-white/20">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="p-2 rounded-xl bg-gradient-to-r" style={{ background: `linear-gradient(135deg, ${colorPalette.primary}, ${colorPalette.secondary})` }}>
              <Code className="w-6 h-6" style={{ color: colorPalette.background }} />
            </div>
            <span className="text-2xl font-bold bg-gradient-to-r bg-clip-text text-transparent" style={{ backgroundImage: `linear-gradient(to right, ${colorPalette.text}, ${colorPalette.primary})` }}>
              TechFlow
            </span>
          </div>
          ...
          <Button className="bg-gradient-to-r shadow-lg hover:shadow-xl transition-all duration-300" style={{ background: `linear-gradient(135deg, ${colorPalette.primary}, ${colorPalette.secondary})`, color: colorPalette.background }}>
            Get Started
          </Button>
        </div>
      </header>
      ...
      {/* Hero Section */}
      <section className="relative z-10 px-6 py-24" style={{ backgroundColor: colorPalette.background }}>
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-6xl md:text-8xl font-bold mb-8 leading-tight">
            <span style={{ color: colorPalette.text }}>Build the</span>
            <br />
            <span className="bg-gradient-to-r bg-clip-text text-transparent" style={{ backgroundImage: `linear-gradient(135deg, ${colorPalette.primary}, ${colorPalette.secondary}, ${colorPalette.accent})` }}>
              future
            </span>
          </h1>
          
          <p className="text-xl mb-12 max-w-3xl mx-auto leading-relaxed" style={{ color: colorPalette.textLight }}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <Button 
              ...
              style={{ background: `linear-gradient(135deg, ${colorPalette.primary}, ${colorPalette.secondary})`, color: colorPalette.background }}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={index} className="backdrop-blur-md bg-white/5 rounded-2xl p-8 border border-white/10 hover:bg-white/10 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold mb-2" style={{ color: colorPalette.text }}>
                  {feature.title}
                </h3>
                <p style={{ color: colorPalette.textLight }}>
                  {feature.desc}
                </p>
              </div>
            ))}
